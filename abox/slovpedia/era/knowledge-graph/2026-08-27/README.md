...
- `data/*.nt.gz` – uložený výsledok príslušného dotazu v komprimovanom
  N-Triples;
...
v `.nt.gz` zostávajú pôvodné URI ERA pod `http://data.europa.eu/949/`.
